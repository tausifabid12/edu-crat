...
import CampaignAdminModal from '@/components/AdminDashboardComponents/CampaignAdminModal/CampaignAdminModal';
...
const Campaign = () => {
  ...
  return (
    <>
      ...
      <CampaignAdminModal setOpenModal={setOpenModal} openModal={openModal} />
    </>
  );
};
